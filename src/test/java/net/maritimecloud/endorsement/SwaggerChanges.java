 ...
 */
package net.maritimecloud.endorsement;
...
public class SwaggerChanges {
    ...
    /**
     * Compares the generated Swagger file against the current prod Swagger file
     */
    @Test
    public void testSwagger() {
        String currentSwagger = "https://endorse.maritimecloud.net/v2/api-docs"; // TODO: needs to be changed when migrating to new url
